...
function edit(id){
    document.location.href="index.php?r=/education&page=option/edit&id="+id;
}
function view(id){
    document.location.href="index.php?r=/education&page=option/view&id="+id;
}
function add(){
    document.location.href="index.php?r=/education&page=option/add";
}
