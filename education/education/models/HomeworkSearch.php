...
from homework as a ".$sqlLeft." left join info_teacher as c on a.tid = c.it_id where 1=1";
    ...
    public function searchByTeacher($params)
    {
        ...
        $sql="select a.img,a.`desc`,a.time,a.title,icl_number,finish_time,is_name,score,a.id as hid,b.id as shid,b.sid,b.stime as stime,b.simg as simg,b.sdesc as sdesc,b.ttime as ttime,b.tdesc as tdesc, wu.path, wu.file as upload_img, wu.img_file
              from homework as a 
