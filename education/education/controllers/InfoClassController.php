...
class InfoClassController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        foreach ($models as $key => $value) {
            $cid =  $value['icl_id'];
            $sql = "SELECT b.title,c.it_name as tname from class_teacher as a,outline as b,info_teacher as c where a.tid = c.it_id and a.cid = b.cid and c.it_id = b.tid  and a.cid = $cid";
